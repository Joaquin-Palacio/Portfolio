      ...
      <ul>
        {links.map(({ id, href, style, child, download }) => (
          <li
            key={id}
            className={
              'flex justify-between items-center w-40 h-14 px-4 ml-[-100px] hover:ml-[-10px] hover:rounded-md duration-300 bg-gray-500 hover:bg-gradient-to-r from-cyan-600 to-blue-700' +
              ' ' +
              style
            }
          >
